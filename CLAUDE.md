...
После разработки функционала нужно разрабатывать тесты. Покрытие тестами должно быть от 70% на файлы.
...
- Можешь подключаться и проверять работу и логи

## Языки
- в проекте используется i18n. Нужно везде использовать i18n если есть сообщения для пользователя