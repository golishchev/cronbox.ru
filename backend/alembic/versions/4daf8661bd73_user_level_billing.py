...
def upgrade() -> None:
    ...
    op.add_column("subscriptions", sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=True))
    ...
    op.add_column("workspaces", sa.Column("is_blocked", sa.Boolean(), server_default="false", nullable=False))
    op.add_column("workspaces", sa.Column("blocked_at", sa.DateTime(timezone=True), nullable=True))
    ...
    op.create_foreign_key("payments_user_id_fkey", "payments", "users", ["user_id"], ["id"], ondelete="SET NULL")
...
def downgrade() -> None:
    ...
    op.add_column("workspaces", sa.Column("plan_id", postgresql.UUID(as_uuid=True), nullable=True))
    ...
    op.create_foreign_key("workspaces_plan_id_fkey", "workspaces", "plans", ["plan_id"], ["id"])
    ...
    op.add_column("subscriptions", sa.Column("workspace_id", postgresql.UUID(as_uuid=True), nullable=True))
    ...
    op.create_foreign_key(
        "subscriptions_workspace_id_fkey", "subscriptions", "workspaces", ["workspace_id"], ["id"], ondelete="CASCADE"
    )
