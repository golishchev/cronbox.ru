...
def upgrade() -> None:
    ...
    op.add_column("subscriptions", sa.Column("scheduled_billing_period", sa.String(10), nullable=True))

    # Add foreign key for scheduled_plan_id
    op.create_foreign_key(
        "subscriptions_scheduled_plan_id_fkey", "subscriptions", "plans", ["scheduled_plan_id"], ["id"]
    )
