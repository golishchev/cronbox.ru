...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "trigger_type",
            postgresql.ENUM("cron", "delayed", "manual", name="triggertype", create_type=False),
            nullable=False,
        ...
        sa.Column(
            "last_status",
            postgresql.ENUM(
                "pending", "running", "success", "failed", "partial", "cancelled", name="chainstatus", create_type=False
            ),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "method",
            postgresql.ENUM("GET", "POST", "PUT", "PATCH", "DELETE", "HEAD", name="httpmethod", create_type=False),
            nullable=False,
            server_default="GET",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM("pending", "running", "success", "failed", "skipped", name="stepstatus", create_type=False),
            nullable=False,
        ),
    ...
    op.add_column(
        "plans", sa.Column("chain_variable_substitution", sa.Boolean(), nullable=False, server_default="false")
    )
