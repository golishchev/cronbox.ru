  ...
  resources: {
    en: {
      translation: {
        ...
        // Protocol types
        'taskForm.protocolType': 'Protocol Type',
        'taskForm.protocolHttp': 'HTTP',
        'taskForm.protocolIcmp': 'ICMP',
        'taskForm.protocolTcp': 'TCP',
        'taskForm.protocolHttpDescription': 'Make HTTP/HTTPS requests to APIs and webhooks',
        'taskForm.protocolIcmpDescription': 'Send ICMP ping to check host availability',
        'taskForm.protocolTcpDescription': 'Check TCP port availability',
        'taskForm.host': 'Host',
        'taskForm.hostPlaceholder': 'example.com or 192.168.1.1',
        'taskForm.hostRequired': 'Host is required',
        'taskForm.port': 'Port',
        'taskForm.portPlaceholder': 'Port number (1-65535)',
        'taskForm.portRequired': 'Port is required',
        'taskForm.icmpCount': 'Ping Count',
        'taskForm.icmpCountHelp': 'Number of ping packets to send (1-10)',
        ...
        'profile.avatarDescription': 'Upload a profile picture',
        'profile.uploadAvatar': 'Upload Avatar',
        'profile.deleteAvatar': 'Delete Avatar',
        'profile.avatarHint': 'JPG, PNG, GIF or WebP. Max 2MB.',
        'profile.avatarInvalidType': 'Invalid file type',
        'profile.avatarTooLarge': 'File too large',
        'profile.avatarUploaded': 'Avatar uploaded',
        'profile.avatarDeleted': 'Avatar deleted',
        'profile.dangerZone': 'Danger Zone',
        'profile.dangerZoneDescription': 'Irreversible and destructive actions',
        'profile.deleteAccount': 'Delete Account',
        'profile.deleteAccountDescription': 'Permanently delete your account and all data',
        'profile.deleteAccountTitle': 'Delete Account',
        'profile.deleteAccountWarning': 'This action cannot be undone. All your workspaces, tasks, and data will be permanently deleted.',
        'profile.deleteAccountConfirmLabel': 'Type "delete" to confirm',
        'profile.deleteAccountConfirm': 'Delete Account',
        'profile.verifyEmail': 'Verify',
        'profile.verificationEmailSent': 'Verification email sent',
        'profile.verificationEmailSentShort': 'Sent',
        // Notifications
